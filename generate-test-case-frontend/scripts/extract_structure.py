...
Usage:
  ...
  python extract_structure.py --template excel_template/frontend/template.xlsx
  python extract_structure.py --output excel_template/frontend/structure.json
...
def main():
    ...
    parser.add_argument('--template', help='Path to .xlsx template file (default: excel_template/frontend/template.xlsx)')
    parser.add_argument('--output', help='Output path for structure.json (default: excel_template/frontend/structure.json)')
    ...
    template_path = args.template or str(project_root / 'excel_template' / 'frontend' / 'template.xlsx')
    output_path = args.output or str(project_root / 'excel_template' / 'frontend' / 'structure.json')
