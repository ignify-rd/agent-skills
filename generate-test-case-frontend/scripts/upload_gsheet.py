...
def main():
    ...
    parser.add_argument('--structure', help='Path to structure.json (default: excel_template/frontend/structure.json)')
    ...
    # Resolve paths
    structure_path = args.structure or str(project_root / 'excel_template' / 'frontend' / 'structure.json')
